                ...
                <div className={style.testimonials__controls__container}>
                    <div className={style.testimonials__controls__container__play}>
                        ...
                        >
                            ...
                            {this.props.isPlaying ? (<img src={this.state.playButton.srcSelected} alt={this.state.playButton.alt} />) : (<img src={this.state.playButton.src} alt={this.state.playButton.alt} />)}
                    ...
                    <div className={style.testimonials__controls__container__pause}>
                        <button type="button"
                            ...
                            {!this.props.isPlaying ? (<img src={this.state.pauseButton.srcSelected} alt={this.state.pauseButton.alt} />) : (<img src={this.state.pauseButton.src} alt={this.state.pauseButton.alt} />)}
