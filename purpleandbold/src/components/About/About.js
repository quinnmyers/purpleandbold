...
class About extends Component {
    ...
    render() {
        return (
            <div ref={this.aboutBody}>
                <div className={style.about} id="about">
                    <div className={style.about__content}>
                        <div className={style.about__content__container}>
                            <div className={style.about__content__container__left}>
                                <AboutPanels inview={this.state.isInView}></AboutPanels>
                            </div>
                            <div className={style.about__content__container__right}>
                                <img src={brand} alt="Purple and Bold Logo" className={style.about__content__container__right__image} />
